...
def get_model(model_choice, training_parameters):
    ...
    if model_choice == RADIAL_FLOWS:
        raise NotImplementedError(f"{model_choice} can't be loaded, it is not implemented yet.")
...
def save_model(q, model_choice, target):
    """
...
def load_model(model_choice, training_parameters):
